...
complex   (kind=8),allocatable   :: hpsixold(:,:,:,:)  ! Old values of Hï¿½Psix
...
complex (kind=8), allocatable :: hpsiold(:,:,:,:) ! Old values of Hï¿½Psi
...
real      (kind=8)               :: rot_ang=90     ! Angulo de rotación en grados
